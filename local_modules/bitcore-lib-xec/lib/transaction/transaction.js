...
Transaction.prototype._getTxid = function() {
  // eCash/XEC uses Bitcoin's standard transaction identifier: the reversed
  // double-SHA256 of the complete serialized transaction. Stamp's inherited
  // Lotus library used a custom merklized transaction ID here, which produced
  // IDs that did not match Chronik even though the raw XEC transaction itself
  // was valid and broadcast successfully.
