...
2. Implement the staged Signal store adapter on the protected private-state foundation before extending the profile, relay and message schemas. The durable-session and paid-outbox invariants in `DURABLE_SESSION_PERSISTENCE.md` remain mandatory.
