...
export default {
  ...
  chat: {
    donationMessage:
      'Finney is an experimental privacy-focused eCash cryptomessenger derived from the original Stamp project.',
  },
  chatInput: {
    giveLotusSecretly: 'Give XEC Secretly',
  ...
  sendLotusDialog: {
    sendLotusTo: 'Send XEC to',
    amountHint: 'Set the amount of XEC to be sent.',
    amountPlaceholder: 'Enter number of XEC...',
  ...
  setup: {
    ...
    welcome: 'Welcome',
    welcomeToStampChat: 'Finney - Welcome!',
    eulaDisclaimer:
      'This software is very prototype cryptomessenger, and may lose funds. Keep larger amounts of XEC in more established wallets.',
    eulaYouUnderstand:
  ...
  SettingPanel: {
    newContact: 'New Contact',
    contacts: 'Contacts',
    sendBitcoinCash: 'Send XEC',
    recieveBitcoinCash: 'Receive XEC',
    profile: 'Profile',
    settings: 'Settings',
