...
2. Add encrypted private-state storage and the staged store adapter before enabling any v2 message path. The implemented main-process foundation and adapter have no renderer IPC or protocol caller; outbox and receipt transactions remain required.
