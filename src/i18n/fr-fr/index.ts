...
export default {
  ...
  chat: {
    donationMessage:
      'Finney est une messagerie eCash expérimentale axée sur la confidentialité, dérivée du projet Stamp original.',
  },
  chatInput: {
    giveLotusSecretly: 'Donner des XEC discrètement',
  ...
  chatRightDrawer: {
    stampPrice: 'Prix du timbre',
    sendLotus: 'Envoyer des XEC',
    notifications: 'Notifications',
  },
  sendLotusDialog: {
    sendLotusTo: 'Envoyer des XEC à',
    amountHint: 'Combien de XEC voulez vous transmettre.',
    amountPlaceholder: 'Entrez le nombre de XEC...',
  ...
  setup: {
    ...
    welcome: 'Bienvenue',
    welcomeToStampChat: 'Finney - Bienvenue !',
    eulaDisclaimer:
      'Ce logiciel est un prototype qui peut perdre vos fonds. Gardez les sommes importantes en XEC dans des logiciels plus mature.',
    eulaYouUnderstand:
  ...
  newContactDialog: {
    ...
    enterBitcoinCashAddress: 'Entrez une adresse XEC...',
    notFound: 'Non trouvé',
  },
  newTopicDialog: {
  ...
  SettingPanel: {
    newContact: 'Nouveau contact',
    contacts: 'Contacts',
    sendBitcoinCash: 'Envoyer des XEC',
    recieveBitcoinCash: 'Reçevoir des XEC',
    profile: 'Profil',
  ...
  sendAddressDialog: {
    ...
    enterAmount: 'Saisissez le montant (XEC)',
    cancel: 'Annuler',
    send: 'Envoyer',
  },
  contactBookDialog: {
