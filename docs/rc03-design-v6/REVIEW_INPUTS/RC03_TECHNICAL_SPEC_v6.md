...
|---|---|
| [A](RC03_v6_ANNEXES/A_IPC_SCHEMAS_AND_LIMITS.md) | All method grammars, caller/trusted-channel rules, errors, cumulative limits and cancellation |
| [B](RC03_v6_ANNEXES/B_LIFECYCLE_REVISIONS_AND_COMMITS.md) | Startup/candidate/replacement, complete authority records, atomic backend commit/recovery and interfaces |
| [C](RC03_v6_ANNEXES/C_OPERATION_AND_EFFECT_TABLES.md) | Intent, transaction validation, effect/replay reducers and fresh/restart/retained authorization |
| [D](RC03_v6_ANNEXES/D_MIGRATION_AND_DESTRUCTION_RESTART_TABLES.md) | Fresh source fence, cleanup, retention/tombstones, surviving destruction evidence and supersession |
| [E](RC03_v6_ANNEXES/E_DESCRIPTORS_AND_COMPATIBILITY.md) | Complete known-output binding, scalar fallback, exact derivation compatibility and protected-export exception |
| [F](RC03_v6_ANNEXES/F_PROPOSED_CRYPTOGRAPHIC_FORMAT_AND_COMMITMENTS.md) | Canonical authenticated graph, exact library/container proposal, resource budget, portable restore and stable qualification |
| [G](RC03_v6_ANNEXES/G_DEPLOYMENT_TOOLCHAIN_AND_CRYPTOGRAPHY.md) | Windows/provider/backend/deployment, transport/browser privacy, every pending policy and evidence layer |

## N2 — Custody, threat and invariants

Main owns wallet authority and secret operations. Ordinary renderer/general stores must not routinely receive mnemonic/root/identity/output private material; encrypting in main then returning keys does not satisfy this target. Main secrets never travel through a generic storage/sign/derive/export/network bridge. Trusted secret UI is separately scoped and cannot be invoked through ordinary IPC. Renderer compromise is assumed for testing the boundary, not demonstrated by this document. Hostile network input, imported/corrupted/copied records, old writers, lost acknowledgements and process/storage faults are in the specified failure cases. Same-user host compromise, isolated valid U rollback and whole-valid-store rollback absent independent freshness, and forensic erasure are not promised.
...
Review required: targeted Architecture, Security and dedicated Cryptography closure on N10 changed clauses, with the complete frozen neutral package as context. External human cryptographic integration review is separate. Later exact-SHA post-fix independent verification must cover routine-secret exclusion through packaged startup/receive/sign/restart/migration/backup and destructive replacement failures before/after prepare/save/activate/retire. Do not declare Gate1 passed or system security from documentation/internal tests. Stop after delivery; no source implementation.
...
## N8 — Integrated definitions and blocked alternatives
...
## N10 — Neutral changed-clause closure checklist

This is a bounded pass/fail checklist for the changed normative clauses with the unchanged eight-document context available. It contains no prior report conclusions or finding identities. No owner option is selected and no application implementation or acceptance is claimed. Each obligation needs a targeted independent result and residual conditions; surrounding future code/provider requirements are not new prose defects by default.

| Obligation | Pass requires | Changed normative clauses | Planned cases |
|---|---|---|---|
| R1 | Mandatory mixed relationships survive exact-reference export/import; typed ID back-edges never permit a digest cycle or wrong namespace | [clause](RC03_v6_ANNEXES/F_PROPOSED_CRYPTOGRAPHIC_FORMAT_AND_COMMITMENTS.md#f10--typed-links-and-admitted-back-edges) | CL1-01, CL1-02 |
| R5 | Closed Policy and exact commitment preimages are independently constructible, typed/versioned/domain separated and bind caller/target/authorization | [clause](RC03_v6_ANNEXES/F_PROPOSED_CRYPTOGRAPHIC_FORMAT_AND_COMMITMENTS.md#f11--authoritative-commitment-dictionary) | CL5-01, CL5-02 |
| R2 | Original e and recipient B bind the offered sender path; private ownership requires recipient secret or validated output scalar; original derivation preserved | [clause](RC03_v6_ANNEXES/E_DESCRIPTORS_AND_COMPATIBILITY.md#e6--sender-context-record-and-ownership) | CL2-01, CL2-02 |
| R6 | Fresh local activation/approval can prepare from qualified imported inputs, reopen and re-export at admitted capacity without source grants or bare-ID search | [clause](RC03_v6_ANNEXES/F_PROPOSED_CRYPTOGRAPHIC_FORMAT_AND_COMMITMENTS.md#f12--imported-inputs-and-new-native-authority) | CL6-01, CL6-02 |
| R4 | First large snapshot support authenticates without self-staling; real semantic data remains covered; thresholds and complete restore agree | [clause](RC03_v6_ANNEXES/F_PROPOSED_CRYPTOGRAPHIC_FORMAT_AND_COMMITMENTS.md#f13--snapshot-coverage-storage-and-membership) | CL4-01, CL4-02, CL4-03 |
| R3 | Generated credential reaches only bound trusted frame once, is confirmed independently, and lost ACK/navigation/restart cannot redisplay or silently export | [clause](RC03_v6_ANNEXES/A_IPC_SCHEMAS_AND_LIMITS.md#a8--generated-backup-credential-ceremony) | CL3-01, CL3-02 |

[Explicit claim boundary](RC03_v6_ANNEXES/F_PROPOSED_CRYPTOGRAPHIC_FORMAT_AND_COMMITMENTS.md#f14--explicit-freshness-and-exposure-limits): isolated authenticated U rollback is not detected by an independently advancing P/L counter in this proposal. Whole-state rollback, copied prior export/credential, retained reconstructable content/keys and context-qualified compromise limits remain explicit and unselected. CL-LIMIT-01/02 are negative controls. No new freshness mechanism is proposed.

The current proposal uses container format6/payloadSchema3/coverage3 for the qualified graph; logical original envelopes and XEC wire/derivation are preserved. No previous draft format is deployed or silently upgraded. Targeted Architecture checks lifecycle/graph/restore and dictionary schemas; Security checks trusted output/current authority/commitments; Cryptography checks sender compatibility/coverage/commitments/transform and the stated limit. Actual independent encoders, packaged Windows providers/backend, full offline restore and distinct storage-crash campaigns follow later authorized implementation. External human integration remains separately required before adoption, sensitive reliance or recovery-dependent retirement.
